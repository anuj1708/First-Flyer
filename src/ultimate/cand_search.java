...
public class cand_search implements  MouseListener{
...
/*
    public static void main(String arg[]) {
        cand_search es = new cand_search();
    }
 *
 */

    public void mouseClicked(MouseEvent e) {
         cand_search.a1=combo.getSelectedIndex();
        cand_search.a2=combo1.getSelectedIndex();
        cand_search.a3=combo2.getSelectedIndex();
        cand_search.a4=combo3.getSelectedIndex();

        try{
            fa.dispose();
        Candidateaccount.f.dispose();
        new cand_searched();
        }
        catch(Exception ert)
        {}
